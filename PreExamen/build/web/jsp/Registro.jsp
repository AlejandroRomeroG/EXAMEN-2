    ...
    <body>
        <%
            ...
            try{
                ...
                System.out.println("Si se conecto1");
            }
            catch(Exception e){
                System.out.println("NO se conecto1");
            }
        %>
        <header>
            <h1 align="center"></h1>
        ...
        <%
            ...
            String mFav = request.getParameter("materiaFav");
			String cFav = request.getParameter("colorFav");
            String dFav = request.getParameter("deporteFav");
            try{
                if(contra.equals(contra2)){
                    sentencia.executeUpdate("insert into usuario (usuario, contraseña, correo, nombre, apellido_paterno, apellido_materno, telefono, escuela, materiafav, colorfav, deportefav) values('"+usuario+"','"+correo+"','"+contra+"','"+nombre+"','"+apellidoPaterno+"','"+apellidoMaterno+"','"+telefono+"','"+escuela+"','"+mFav+"', '"+cFav+"', '"+dFav+"');");
                    ...
                    try{
                        ...
                        conexion = DriverManager.getConnection(url, user, password);
                        sentencia = conexion.createStatement();
                        System.out.println("Si se conecto2");
                    }
                    catch(Exception e){
                        System.out.println("NO se conecto2");
                    }
